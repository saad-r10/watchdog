...
- **Triggers**: downtime, SSL expiry within 14 days, missing critical headers, unexpected certificate detected via Certificate Transparency logs, monitored domain detected on a threat-intel blocklist (URLhaus/Spamhaus DBL)
