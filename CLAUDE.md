...
Nine recurring workers defined in `apps/backend/src/workers/`:
...
| `Incident` | Downtime, SSL-expiry, header, unexpected-certificate, domain-blocklisted, content-changed, or performance-degraded event |
