      ...
      {editing ? (
        ...
        >
          <div className="flex gap-3">
            ...
            />
            <select
              className="bg-slate-800 border border-slate-700 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-violet-500 focus:ring-1 focus:ring-violet-500"
        ...
        <div className="flex items-center justify-between px-5 py-4 hover:bg-slate-800/30 transition-colors group">
          <div className="min-w-0 flex-1">
            ...
            <p className="text-xs text-slate-500 mt-0.5 truncate">{monitor.url}</p>
          </div>
      ...
      <div className="bg-slate-900 rounded-xl border border-slate-800 p-6 mb-6">
        ...
        >
          <div className="flex gap-3">
            ...
            />
            <select
              className="bg-slate-800 border border-slate-700 rounded-lg px-3 py-2.5 text-sm text-white focus:outline-none focus:border-violet-500 focus:ring-1 focus:ring-violet-500 transition-colors"
